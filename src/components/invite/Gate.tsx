...
export function Gate({ onOpen }: { onOpen: () => void }) {
  ...
  const delay = (ms: number) => ({
    transitionDelay: open ? "0ms" : `${ms}ms`,
  });
  ...
  return (
    <div
      ...
      className="
        ...
        data-[open=true]:pointer-events-none
        data-[open=true]:opacity-0
      "
      style={{
        transitionDelay: open ? "1300ms" : "0ms",
        perspective: "1200px",
      }}
    >
      {/* =========================================================
      ...
      {/* =========================================================
          ...
          IMPORTANT:
          This is full viewport width.
          The previous centered 1000px container caused the flowers
          to bunch toward the center on desktop.
          ========================================================= */}
      <div
        data-open={open}
        className="
          ...
          return (
            <div
              ...
              className="
                ...
                duration-[2400ms]
                ease-[cubic-bezier(0.65,0,0.35,1)]
                data-[in=true]:opacity-100
              "
              style={{
                /*
                 * Each strand is positioned across the entire viewport:
                 *
                 * 0%   = far left
                 * 50%  = center
                 * 100% = far right
                ...
                transform: open
                  ? `translateX(${
                      dir *
                      (60 + Math.abs(50 - s.left) * 2.4)
                    }vw) rotate(${dir * 22}deg)`
                  : entered
            ...
            >
              <img
                ...
                style={{
                  /*
                   * The image itself is centered on its strand position.
                   */
                  translate: "-50% 0",
      ...
      <div
        ...
        className="
          ...
          duration-[1100ms]
          ease-[cubic-bezier(0.19,1,0.22,1)]
          data-[open=true]:scale-[1.35]
          data-[open=true]:opacity-0
        "
      >
        <p
          className={`gold-caps text-lg sm:text-xl ${stagger(0)}`}
          style={delay(500)}
        >
        ...
        >
          ...
          <span className="font-display text-gold relative text-4xl tracking-widest sm:text-5xl">
            ...
            <span className="font-script mx-1 text-2xl text-primary sm:text-3xl">
              &
            </span>
        ...
        <span
          className={`rule-gold mt-5 w-24 ${stagger(0)}`}
          style={delay(1240)}
        />
